 ...
 * @since 2019/3/14
 */
public class SdhLink extends AbstractLink {
    //承载层
    private String carriedLayer;
    //底层承载的fiber链路路由
    private List<FiberLink> fiberLinkList = new ArrayList<FiberLink>();
    //底层承载的wdm链路路由
    private List<WdmLink> wdmLinkList = new ArrayList<WdmLink>();
    //底层承载的otn链路路由
    private List<OtnLink> otnLinkList = new ArrayList<OtnLink>();
    ...
    public static class Builder{
        ...
        private String carriedLayer;//承载层
        ...
        public Builder carriedLayer(String val){
            this.carriedLayer = val;
            return this;
        }
    ...
    private SdhLink(Builder builder){
        ...
        this.carriedLayer = builder.carriedLayer;//承载层
